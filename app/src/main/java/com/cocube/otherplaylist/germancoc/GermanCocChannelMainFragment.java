...
public class GermanCocChannelMainFragment extends Fragment {

    private final Handler handler = new Handler();

    private PagerSlidingTabStrip tabs;
    private ViewPager pager;
    private GermanCocChannelPagerAdapter adapter;
    ...
    void setUpPager(View view){
        ...
        adapter = new GermanCocChannelPagerAdapter(getView().getContext(), getChildFragmentManager());
    ...
    void setUpTabColor(){
        mSlidingTabLayout.setCustomTabColorizer(new SlidingTabLayout.TabColorizer() {
            ...
            public int getIndicatorColor(int position) {
                return GermanCocChannelMainFragment.this.getResources().getColor(R.color.tab_indicator);
            }
            @Override
            public int getDividerColor(int position) {
                return GermanCocChannelMainFragment.this.getResources().getColor(R.color.tab_underline);
            }
        });
    }
