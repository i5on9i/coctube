...
public class CocTube2MainFragment extends Fragment {
    ...
    private CocTube2PagerAdapter adapter;
    ...
    void setUpPager(View view){
        ...
        adapter = new CocTube2PagerAdapter(getView().getContext(), getChildFragmentManager());
    ...
    void setUpTabColor(){
        mSlidingTabLayout.setCustomTabColorizer(new SlidingTabLayout.TabColorizer() {
            ...
            public int getIndicatorColor(int position) {
                return CocTube2MainFragment.this.getResources().getColor(R.color.tab_indicator);
            }
            @Override
            public int getDividerColor(int position) {
                return CocTube2MainFragment.this.getResources().getColor(R.color.tab_underline);
            }
        });
    }
