...
public class KazaMainFragment extends SherlockFragment{

    private final Handler handler = new Handler();

    private PagerSlidingTabStrip tabs;
    private ViewPager pager;
    private KazaPagerAdapter adapter;
...
//        setContentView(R.layout.main_with_menu);
        ...
        adapter = new KazaPagerAdapter(getView().getContext(), getChildFragmentManager());
