...
public class OnGameNetMainFragment extends SherlockFragment{

    private final Handler handler = new Handler();

    private PagerSlidingTabStrip tabs;
    private ViewPager pager;
    private OnGameNetPagerAdapter adapter;
...
//        setContentView(R.layout.main_with_menu);
        ...
        adapter = new OnGameNetPagerAdapter(getView().getContext(), getChildFragmentManager());
