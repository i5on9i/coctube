...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int currentPositionDuringScroll = 0;
    ...
    public void notifyDataSetChanged() {
        ...
        // 2014. 1. 1
        // This listener is invoked only when the view is drew again.
        // Without this, nothing is changed but, with this,
        // Drawing after pager.setCurrentItem() works not correctly.
...
//				}
//
//				currentPositionDuringScroll = pager.getCurrentItem();
//				scrollToChild(currentPositionDuringScroll, 0);
//			}
//		});
    ...
    protected void onDraw(Canvas canvas) {
        ...
        View currentTab = tabsContainer.getChildAt(currentPositionDuringScroll);
        float lineLeft = currentTab.getLeft();
        float lineRight = currentTab.getRight();

        // if there is an offset, start interpolating left and right coordinates between current and next tab
        if (currentPositionOffset > 0f && currentPositionDuringScroll < tabCount - 1) {

            View nextTab = tabsContainer.getChildAt(currentPositionDuringScroll + 1);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            currentPositionDuringScroll = position;
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        currentPositionDuringScroll = savedState.currentPosition;
        requestLayout();
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.currentPosition = currentPositionDuringScroll;
        return savedState;
    }
