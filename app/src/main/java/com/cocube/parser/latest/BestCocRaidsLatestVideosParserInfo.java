 ...
 */
public class BestCocRaidsLatestVideosParserInfo implements ParserInfo {

    private int mStartIndex = 1;
    private int mMaxResult = 10;


    private static final String CHANNEL_ID = "UCNFWcCw-Kyr5i4-4nnBF7HA";    // https://www.youtube.com/channel/UC4Vxtl8TqjlsPcHzlO7UoIg
    ...
    public BestCocRaidsLatestVideosParserInfo(int startIndex) {
